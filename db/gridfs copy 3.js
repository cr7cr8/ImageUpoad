                    ...
                    Jimp.read(buf).then(function (image) {
                        image
                            ...
                            .then(function (imgBuffer) {
                                ...
                                var gfs = new mongoose.mongo.GridFSBucket(self.db.db, {
                                    chunkSizeBytes: 255 * 1024,
                                    bucketName: "sssss" + self.schema.options.collection,
                                });

                                const gfsws = gfs.openUploadStream("ssss" + self.schema.options.collection, "aaa.png",)


                                gfsws.write(imgBuffer);
                                gfsws.end();
                                //       const aaa =    fs.createWriteStream("./nnn.png");
                                //          aaa.write(imgBuffer);


                                // fs.createReadStream("./aaa.png").pipe(gfsws);
                                //gfsws.write("aaaa",)
                            })
